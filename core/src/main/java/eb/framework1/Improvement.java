 ...
 * The hiddenValue (0-4) indicates how difficult the improvement is to discover:
 * <ul>
 *   <li>0 = no investigation needed, but the location must be visited first</li>
 *   <li>1-4 = increasing difficulty; a Perception score &ge; hiddenValue reveals it</li>
 * </ul>
 *
...
public class Improvement {
     ...
     * @param hiddenValue How hidden the improvement is (0-4, where 0 = easiest to find)
     */
    public Improvement(String name, int level, int hiddenValue) {
        ...
        if (hiddenValue < 0 || hiddenValue > 4) {
            throw new IllegalArgumentException("Hidden value must be between 0 and 4");
        }
        this.name = name.trim();
        this.level = level;
