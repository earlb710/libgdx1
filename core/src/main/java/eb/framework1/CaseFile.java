 ...
 * hidden facts the player must uncover to solve the case — and a
 * <em>complexity</em> level (1–3, hidden from the player) that controls how many
 * plot twists the investigation contains (1 = none, 2 = one, 3 = two).
 */
