...
public class ShopItem {
     ...
     */
    public ShopItem(String name, String description, int price, boolean consumable, int staminaGain) {
     ...
     */
    public ShopItem(String name, String description, int price, boolean consumable) {
