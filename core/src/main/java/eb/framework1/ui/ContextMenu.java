...
public class ContextMenu {
     ...
     */
    public void show(float screenX, float flippedY,
     ...
     * currently open.
     */
    public void draw(SpriteBatch batch, ShapeRenderer sr, BitmapFont font, GlyphLayout gl) {
     ...
     */
    public int onTap(float screenX, float flippedY) {
    ...
    public boolean contains(float screenX, float flippedY) {
