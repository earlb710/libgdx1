...
class PhonePopup {
    ...
    PhonePopup(SpriteBatch batch, ShapeRenderer sr,
     ...
     */
    void show(List<PhoneContact> contactList) {
        contacts.clear();
