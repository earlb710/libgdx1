 ...
 *
 * <p>Descriptions are stored in {@code text/buildings_en.json} under the
 * {@code "descriptions"} and {@code "improvements"} sections, alongside the building
 * definitions.  English is the default and is used as a fallback when a requested language
 * has no entry for the given key.</p>
 *
 ...
 * <pre>{@code
 * String json = Gdx.files.internal("text/buildings_en.json").readString("UTF-8");
...
public class NovelTextEngine {
    ...
    static final class DescriptionEntry {
        ...
        public final Map<TimeOfDay, String> timeVariants;
        public final Map<String, String> attributeVariants;
        public final Map<String, String> genderVariants;
        public final Map<String, String> stateVariants;

        public DescriptionEntry(String defaultText,
     ...
     */
    public NovelTextEngine(Map<String, List<DescriptionEntry>> entries,
