...
public class NotePopup {
    ...
    public NotePopup(SpriteBatch batch, ShapeRenderer sr,
    ...
    public String  getNoteText()       { return noteText.toString().trim(); }

    /** Opens the popup, seeding checkboxes and clearing the text area. */
    public void show(boolean includeTime, boolean includeLocation) {
