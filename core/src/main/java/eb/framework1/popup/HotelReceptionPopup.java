 ...
 * </pre>
 */
public class HotelReceptionPopup {
    ...
    public HotelReceptionPopup(SpriteBatch batch, ShapeRenderer sr,
    ...
    public int     getNightlyCost() { return nightly; }
     ...
     */
    public int getDiscountedTotal(int nights) {
