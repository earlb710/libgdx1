...
public class HelpPopup {
    ...
    // Constructor
    // -------------------------------------------------------------------------
    public HelpPopup(SpriteBatch batch, ShapeRenderer shapeRenderer,
     ...
     */
    public boolean onTap(int screenX, int flippedY) {
     ...
     */
    public void draw(int screenW, int screenH, int infoAreaH) {
