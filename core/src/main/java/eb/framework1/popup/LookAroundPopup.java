...
public class LookAroundPopup {
    ...
    public LookAroundPopup(SpriteBatch batch, ShapeRenderer shapeRenderer,
    ...
    public boolean isVisible()   { return state != State.IDLE; }
    public boolean isAnimating() { return state == State.ANIMATING; }
    public boolean isResults()   { return state == State.RESULTS; }
    ...
    public void start(int charX, int charY) {
        lookCharX = charX;
        lookCharY = charY;
        foundItems.clear();
        impDesc   = null;
    ...
    public void draw(int screenW, int screenH, int infoAreaHeight) {
        final float PAD    = 24f;
