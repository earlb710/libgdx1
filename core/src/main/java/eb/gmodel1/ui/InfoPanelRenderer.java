...
public class InfoPanelRenderer {
    ...
    public static final Color         LABEL_COLOR            = new Color(0f,    1f,    0f,    1f);
    private static final Color ATTR_TOTAL_COLOR       = new Color(0.5f,  1.0f,  0.5f,  1f);
    public static final Color         NOVEL_COLOR            = new Color(0.70f, 0.90f, 1.00f, 1f);
    ...
    public void drawInfoBar(MapViewState s) {
    ...
    public void drawInfoBlock(MapViewState s, boolean lookAroundIdle) {
    ...
    private void drawCharacterTab(MapViewState s, int panelH) {
        ...
        // Count attributes that are actually displayed (MUSCLE_KG and FAT_KG are hidden)
        int displayedAttrCount = 0;
        for (CharacterAttribute attr : attrs) {
            if (attr != CharacterAttribute.MUSCLE_KG && attr != CharacterAttribute.FAT_KG) {
                displayedAttrCount++;
            }
        }
    ...
    public static String floorOrdinal(int n) {
        if (n <= 0) return n + "th";
        int mod100 = n % 100;
    ...
    public static String formatAttributeModifiers(Map<CharacterAttribute, Integer> modifiers) {
