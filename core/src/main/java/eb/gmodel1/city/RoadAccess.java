...
public class RoadAccess {
    ...
    public void setNorthType(RoadType type) {
        this.north = type;
    }

    public void setSouthType(RoadType type) {
        this.south = type;
    }

    public void setEastType(RoadType type) {
        this.east = type;
    }

    public void setWestType(RoadType type) {
        this.west = type;
    }
